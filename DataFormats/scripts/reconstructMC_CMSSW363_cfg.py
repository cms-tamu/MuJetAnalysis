...
# with command line options: reconstruct -s RAW2DIGI,RECO --filein file://tmp.root --eventcontent RECOSIM --datatier GEN-SIM-RECO --conditions FrontierConditions_GlobalTag,MC_36Y_V10::All -n -1 --no_exec
