...
################## BEGIN ADDED BY HAND
import os
GENINFOFILE = os.getenv("GENINFOFILE")
...
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring(GENINFOFILE))
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/PairGun100_cfg nevts:-1'),
