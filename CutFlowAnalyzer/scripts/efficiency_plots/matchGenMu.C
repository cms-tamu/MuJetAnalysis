...
int MatchRECOtoGENdimuons(double etaC, double phiC, double etaF, double phiF, 
			  double etaAC, double phiAC, double etaAF, double phiAF){
  int matchInt = -999;
...
gROOT->SetBatch(kTRUE);
  ...
  while ((chEl=(TChainElement*)next())) {
    ...
    t->SetBranchStatus("genA1Mu0_phi",1);
    t->SetBranchStatus("genA1Mu0_eta",1);
    t->SetBranchStatus("genA0Mu0_phi",1);
    t->SetBranchStatus("genA0Mu0_eta",1);
    t->SetBranchStatus("genA1Mu1_phi",1);
    t->SetBranchStatus("genA1Mu1_eta",1);
    t->SetBranchStatus("genA0Mu1_phi",1);
    t->SetBranchStatus("genA0Mu1_eta",1);
