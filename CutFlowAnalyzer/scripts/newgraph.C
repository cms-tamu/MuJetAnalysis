...
Float_t epsvsalph3[20]={0.0};
Float_t epsvsalph4[20]={0.0};
Float_t epsvsalph5[20]={0.0};
Float_t epsvsalph6[20]={0.0};
Float_t Err[20]={0.0};
...
//   f[1] = new TFile("DarkSUSY_mH_125_mGammaD_0700_ctauExp_02_8TeV-madgraph452_bridge224_LHE_pythia6_5374_PAT_v1_10000.root");
	...
	// 5) allocate var to branch
		...
		for(int i=0;i<nentries;i++){ //loop for number of events
		  ...
		  if(is2DiMuons){
			...
			(diMuonF_m1_FittedVtx_hitpix_l3inc[0]==1||diMuonF_m2_FittedVtx_hitpix_l3inc[1]==1)){
		      counter[k][16]++;
 ...
 //  c3->SaveAs("pt_mu3.png","recreate");
		...
		epsvsalph1[k] = counter[k][10]/(counter[k][5]*1.0);//2dimuon/alpha 
		epsvsalph[k] = counter[k][16]/(counter[k][5]*1.0); //mainvalue of epsilob_rec/alpha_gen
		epsvsalph2[k] = counter[k][11]/(counter[k][5]*1.0);//is2DiMuonsFittedVtx/alph 
		epsvsalph3[k] = counter[k][12]/(counter[k][5]*1.0);
		epsvsalph4[k] = counter[k][13]/(counter[k][5]*1.0);
		epsvsalph5[k] = counter[k][14]/(counter[k][5]*1.0);
		epsvsalph6[k] = counter[k][15]/(counter[k][5]*1.0);

		cout<<" mass  "<<mass_string<<" cT  "<<cT_string<<endl;
                cout<<" epsvsalph1[k]  "<<epsvsalph1[k]<<endl;

		//cout<<" mass  "<<mass_string<<" cT  "<<cT_string<<endl;
		cout<<" epsvsalph[k]  "<<epsvsalph[k]<<endl;

		//	cout<<" mass  "<<mass_string<<" cT  "<<cT_string<<endl;
                cout<<" epsvsalph2[k]  "<<epsvsalph2[k]<<endl;
		//	cout<<" mass  "<<mass_string<<" cT  "<<cT_string<<endl;
                cout<<" epsvsalph3[k]  "<<epsvsalph3[k]<<endl;
		//	cout<<" mass  "<<mass_string<<" cT  "<<cT_string<<endl;
                cout<<" epsvsalph4[k]  "<<epsvsalph4[k]<<endl;
		//		cout<<" mass  "<<mass_string<<" cT  "<<cT_string<<endl;
                cout<<" epsvsalph5[k]  "<<epsvsalph5[k]<<endl;

                cout<<" epsvsalph6[k]  "<<epsvsalph6[k]<<endl;
		...
		cout<<" is2DiMuonsFittedVtx  &  "<< counter[k][16]<<"  &    "<< TotEff[k][16]<<" &     "<< RelEff[k][16]<<" &   "<<fixed<<std::setprecision(4) << TotEffErr[k][16]<<" &  "<<fixed<<std::setprecision(3) << RelEffErr[k][16]<<" hline "<<endl;                                
		cout<<" is2DiMuonsFittedDz   &  "<< counter[k][11]<<"  &    "<< TotEff[k][11]<<" &     "<< RelEff[k][11]<<" &   "<<fixed<<std::setprecision(4) << TotEffErr[k][11]<<" &  "<<fixed<<std::setprecision(3) << RelEffErr[k][11]<<" hline "<<endl;                                
		cout<<" is2DiMuonsMassOK     &  "<< counter[k][12]<<"  &    "<< TotEff[k][12]<<" &     "<< RelEff[k][12]<<" &   "<<fixed<<std::setprecision(4) << TotEffErr[k][12]<<" &  "<<fixed<<std::setprecision(3) << RelEffErr[k][12]<<" hline "<<endl;                              
		cout<<" is2DiMuonHLTFired    &  "<< counter[k][13]<<"  &    "<< TotEff[k][13]<<" &     "<< RelEff[k][13]<<" &   "<<fixed<<std::setprecision(4) << TotEffErr[k][13]<<" &  "<<fixed<<std::setprecision(3) << RelEffErr[k][13]<<" hline "<<endl;
		...
		cout<<" is2DiMuonsPixHitOK   &  "<< counter[k][15] <<" &    "<< TotEff[k][15]<<" &     "<< RelEff[k][15]<<" &   "<<fixed<<std::setprecision(4) << TotEffErr[k][15]<<" &  " <<fixed<<std::setprecision(3) << RelEffErr[k][15]<<" hline "<<endl;                                   
 
		cout
		  <<"                                                           "<<" hline "<<endl;
		cout<<" epsilon_rec1/alpha_gen  & "<< epsvsalph1[k]<<"$\\pm$ "<< Err[k]<<" hline "<<endl;
		cout<<" epsilon_rec/alpha_gen   & "<< epsvsalph[k]<<"$\\pm$ "<< Err[k]<<" hline "<<endl;
		cout<<" epsilon_rec2/alpha_gen  & "<< epsvsalph2[k]<<"$\\pm$ "<< Err[k]<<" hline "<<endl;
		cout<<" epsilon_rec3/alpha_gen  & "<< epsvsalph3[k]<<"$\\pm$ "<< Err[k]<<" hline "<<endl;
		cout<<" epsilon_rec4/alpha_gen  & "<< epsvsalph4[k]<<"$\\pm$ "<< Err[k]<<" hline "<<endl;
		cout<<" epsilon_rec5/alpha_gen  & "<< epsvsalph5[k]<<"$\\pm$ "<< Err[k]<<" hline "<<endl;
		cout<<" epsilon_rec6/alpha_gen  & "<< epsvsalph6[k]<<"$\\pm$ "<< Err[k]<<" hline "<<endl;
