...
config.General.requestName = 'crab_2016G_MuOnia'
...
config.Data.inputDataset = '/MuOnia/Run2016G-23Sep2016-v1/AOD'
...
config.Data.outputDatasetTag = 'MuOnia_Run2016G_AnaPromptJpsi'
