...
config.General.requestName = 'crab_2016H1_MuOnia'
...
config.Data.inputDataset = '/MuOnia/Run2016H-PromptReco-v1/AOD'
...
config.Data.outputDatasetTag = 'MuOnia_Run2016H1_AnaPromptJpsi'
