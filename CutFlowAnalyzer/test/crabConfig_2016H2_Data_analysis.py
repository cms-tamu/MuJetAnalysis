...
config.General.requestName = 'crab_2016H2_MuOnia'
...
config.Data.inputDataset = '/MuOnia/Run2016H-PromptReco-v2/AOD'
...
config.Data.outputDatasetTag = 'MuOnia_Run2016H2_AnaPromptJpsi'
