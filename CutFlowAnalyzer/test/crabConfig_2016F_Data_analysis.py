...
config.General.requestName = 'crab_2016F_MuOnia'
...
config.Data.inputDataset = '/MuOnia/Run2016F-23Sep2016-v1/AOD'
...
config.Data.outputDatasetTag = 'MuOnia_Run2016F_AnaPromptJpsi'
