...
config.General.requestName = 'crab_2016E_MuOnia'
...
config.Data.inputDataset = '/MuOnia/Run2016E-23Sep2016-v1/AOD'
...
config.Data.outputDatasetTag = 'MuOnia_Run2016E_AnaPromptJpsi'
