...
config.General.requestName = 'crab_2016C_MuOnia_AnaPromptJpsi_v3'
...
config.Data.inputDataset = '/MuOnia/Run2016C-23Sep2016-v1/AOD'
...
config.Data.outputDatasetTag = 'MuOnia_Run2016C_AnaPromptJpsi_v3'
