## Customization for HLT_TrkMu16_DoubleTrkMu6NoFiltersNoVtx_v1

import FWCore.ParameterSet.Config as cms

hltPreTrkMu16DoubleTrkMu6NoFiltersNoVtx = cms.EDFilter( "HLTPrescaler",
...
hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered6NoVtx = cms.EDFilter("HLTMuonL3PreFilter",
...
hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered16NoVtx = cms.EDFilter("HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 9999.0 ),
    saveTags = cms.bool( True ),
...
hltTripleTrkMuFiltered6NoVtx = cms.EDFilter("HLTMuonTrkFilter",
...
hltSingleTrkMuFiltered16NoVtx = cms.EDFilter("HLTMuonTrkFilter",
    maxNormalizedChi2 = cms.double( 1.0E99 ),
    saveTags = cms.bool( False ),
    maxAbsEta = cms.double( 2.5 ),
    previousCandTag = cms.InputTag( "" ),
...
def add_HLT_TrkMu16_DoubleTrkMu6NoFiltersNoVtx_v1(process):

    process.hltPreTrkMu16DoubleTrkMu6NoFiltersNoVtx = hltPreTrkMu16DoubleTrkMu6NoFiltersNoVtx
    ...
    process.hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered6NoVtx = hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered6NoVtx
    process.hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered16NoVtx = hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered16NoVtx
    process.hltTripleTrkMuFiltered6NoVtx = hltTripleTrkMuFiltered6NoVtx 
    process.hltSingleTrkMuFiltered16NoVtx = hltSingleTrkMuFiltered16NoVtx
    ...
    process.HLT_TrkMu16_DoubleTrkMu6NoFiltersNoVtx_v2017 = cms.Path( 
        process.HLTBeginSequence + 
        process.hltL1sL1DoubleMu103p5ORDoubleMu125 + 
        process.hltPreTrkMu16DoubleTrkMu6NoFiltersNoVtx + 
        ...
        process.hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered6NoVtx + 
        process.hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered16NoVtx +
        process.HLTTrackerMuonSequenceNoVtx + 
        process.hltTripleTrkMuFiltered6NoVtx + 
        process.hltSingleTrkMuFiltered16NoVtx + 
