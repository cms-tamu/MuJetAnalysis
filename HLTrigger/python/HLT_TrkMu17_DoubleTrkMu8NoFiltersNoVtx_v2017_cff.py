## Customization for HLT_TrkMu17_DoubleTrkMu5NoFiltersNoVtx_v1

import FWCore.ParameterSet.Config as cms

hltPreTrkMu17DoubleTrkMu5NoFiltersNoVtx = cms.EDFilter( "HLTPrescaler",
...
hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered8NoVtx = cms.EDFilter("HLTMuonL3PreFilter",
...
hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered17NoVtx = cms.EDFilter("HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 9999.0 ),
    saveTags = cms.bool( True ),
...
hltTripleTrkMuFiltered8NoVtx = cms.EDFilter("HLTMuonTrkFilter",
...
hltSingleTrkMuFiltered17NoVtx = cms.EDFilter("HLTMuonTrkFilter",
    maxNormalizedChi2 = cms.double( 1.0E99 ),
    saveTags = cms.bool( False ),
    maxAbsEta = cms.double( 2.5 ),
    previousCandTag = cms.InputTag( "" ),
...
def add_HLT_TrkMu17_DoubleTrkMu5NoFiltersNoVtx_v1(process):

    process.hltPreTrkMu17DoubleTrkMu5NoFiltersNoVtx = hltPreTrkMu17DoubleTrkMu5NoFiltersNoVtx
    ...
    process.hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered8NoVtx = hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered8NoVtx
    process.hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered17NoVtx = hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered17NoVtx
    process.hltTripleTrkMuFiltered8NoVtx = hltTripleTrkMuFiltered8NoVtx 
    process.hltSingleTrkMuFiltered17NoVtx = hltSingleTrkMuFiltered17NoVtx
    ...
    process.HLT_TrkMu17_DoubleTrkMu5NoFiltersNoVtx_v1 = cms.Path( 
        process.HLTBeginSequence + 
        process.hltL1sL1DoubleMu103p5ORDoubleMu125 + 
        process.hltPreTrkMu17DoubleTrkMu5NoFiltersNoVtx + 
        ...
        process.hltL3pfL1sDoubleMu103p5L1f0L2pf0TwoMuL3PreFiltered8NoVtx + 
        process.hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered17NoVtx +
        process.HLTTrackerMuonSequenceNoVtx + 
        process.hltTripleTrkMuFiltered8NoVtx + 
