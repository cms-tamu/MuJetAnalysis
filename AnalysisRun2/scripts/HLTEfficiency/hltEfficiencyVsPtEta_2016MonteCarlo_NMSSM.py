...
def makePlot(effTuple, triggerPath, format='pdf'):
    ...
    hist.saveDir     = 'trigger_efficiency_plots_2016MonteCarlo_NMSSM_20170209/'
    hist.saveAs      = "eff_" + triggerPath + "_2016MonteCarlo_NMSSM_" + effTuple[2] # save figure with name
