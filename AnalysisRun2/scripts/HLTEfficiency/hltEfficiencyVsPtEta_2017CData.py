...
def efficiency_trigger(dirNames, triggerPaths):
    ...
    addfilesMany(chain, dirNames, "out_ana_selected_MET_2017C_20171012.root")
...
#                    tree.is2DiMuonsMassOK_FittedVtx and
    ...
    MyFile = TFile("HLT_efficiency_signal_backup_2017C_13TeV.root","RECREATE");
...
triggerPaths = ["HLT_TrkMu12_DoubleTrkMu5NoFiltersNoVtx", 
...
def makePlot(effTuple, triggerPath, format='pdf'):
    ...
    if 'full' in effTuple[0].GetName():
        ...
        hist.saveAs      = "eff_" + triggerPath + "_2017C_" + effTuple[2] # save figure with name
...
MyFile = TFile("HLT_efficiency_signal_backup_2017C_13TeV.root");
