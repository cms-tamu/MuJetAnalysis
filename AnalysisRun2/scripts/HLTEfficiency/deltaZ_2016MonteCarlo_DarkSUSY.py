...
def deltaZ(dirNames):
    ...
    deltaZ_DiMuonC_DiMuonF = ROOT.TH1D("deltaZ_DiMuonC_DiMuonF","",2000,-1,1);
    ...
    chain.Draw("diMuons_dz_FittedVtx>>deltaZ_DiMuonC_DiMuonF","is4SelMu8 && isVertexOK && is2MuJets && is2DiMuons && (diMuonF_m1_FittedVtx_hitpix_l3inc==1 || diMuonF_m2_FittedVtx_hitpix_l3inc==1) && (diMuonC_m1_FittedVtx_hitpix_l3inc==1 || diMuonC_m2_FittedVtx_hitpix_l3inc==1) && diMuonC_IsoTk_FittedVtx < 2 && diMuonF_IsoTk_FittedVtx < 2 && is2DiMuonsMassOK_FittedVtx")
