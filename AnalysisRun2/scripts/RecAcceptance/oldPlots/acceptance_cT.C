...
//=========  (Thu Oct 22 11:28:18 2015) by ROOT version6.02/05
   TCanvas *c = new TCanvas("c", "c",321,1245,700,500);
   gStyle->SetOptStat(0);
   c->Range(-0.8750001,-0.025,5.875,0.225);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH2F *dummy31 = new TH2F("dummy31","dummy3",100,-0.2,5.2,100,0,0.2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","Graph",100,0,5.5);
   Graph_Graph1001->SetMinimum(0);
   Graph_Graph1001->SetMaximum(0.09627268);
   ...
   Graph_Graph1004->SetMinimum(0.001067391);
   Graph_Graph1004->SetMaximum(0.06856573);
   ...
   0.001147773,
   0.0009510256};
   gre = new TGraphErrors(8,Graph4_fx1005,Graph4_fy1005,Graph4_fex1005,Graph4_fey1005);
   gre->SetName("Graph4");
   gre->SetTitle("Graph");
   gre->SetFillColor(1);
   gre->SetLineColor(6);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","Graph",100,0,5.495);
   Graph_Graph1005->SetMinimum(0.07051278);
   Graph_Graph1005->SetMaximum(0.1449169);
