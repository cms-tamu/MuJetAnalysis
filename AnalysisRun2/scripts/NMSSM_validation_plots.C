...
void makePlot(TH1F * hhh, TString cTitle)
{
  ...
  TLegend *leg = new TLegend(0.6,0.82,0.95,0.9066667,NULL,"brNDC");
  leg->SetBorderSize(0);
  ...
  leg->SetFillColor(0);
  leg->SetFillStyle(0);
  TLegendEntry *entry=leg->AddEntry("NULL","#splitline{pp #rightarrow h #rightarrow 2a #rightarrow 4#mu}{m_{h_{1,2}} = 125 GeV, m_{a} = 0.25 GeV}","h");
...
void efficiency(const std::vector<std::string>& dirNames)
{
  ...
  TH1F * h_genH_m = new TH1F("h_genH_m","CMS Simulation (Pythia) 13 TeV; Mass of h [GeV]; Fraction of events",100,100,150);
  TH1F * h_genH_px = new TH1F("h_genH_px","CMS Simulation (Pythia) 13 TeV; p_{x} of h [GeV]; Fraction of events",100,-500,500);
  TH1F * h_genH_py = new TH1F("h_genH_py","CMS Simulation (Pythia) 13 TeV; p_{y} of h [GeV]; Fraction of events",100,-500,500);
  TH1F * h_genH_pz = new TH1F("h_genH_pz","CMS Simulation (Pythia) 13 TeV; p_{z} of h [GeV]; Fraction of events",100,-500,500);
  TH1F * h_genH_eta = new TH1F("h_genH_eta","CMS Simulation (Pythia) 13 TeV; #eta of h; Fraction of events",100,-2.5,2.5);
  TH1F * h_genH_phi = new TH1F("h_genH_phi","CMS Simulation (Pythia) 13 TeV; #phi of h; Fraction of events",100,-3.2,3.2);
  
  TH1F * h_genA0_m = new TH1F("h_genA0_m","CMS Simulation (Pythia) 13 TeV; Mass of A0 [GeV]; Fraction of events",100,0,100);
  TH1F * h_genA0_pT = new TH1F("h_genA0_pT","CMS Simulation (Pythia) 13 TeV; p_{T} of A0 [GeV]; Fraction of events",100,0,100);
  TH1F * h_genA0_px = new TH1F("h_genA0_px","CMS Simulation (Pythia) 13 TeV; p_{x} of A0 [GeV]; Fraction of events",100,-100,100);
  TH1F * h_genA0_py = new TH1F("h_genA0_py","CMS Simulation (Pythia) 13 TeV; p_{y} of A0 [GeV]; Fraction of events",100,-100,100);
  TH1F * h_genA0_pz = new TH1F("h_genA0_pz","CMS Simulation (Pythia) 13 TeV; p_{z} of A0 [GeV]; Fraction of events",100,-100,100);
  TH1F * h_genA0_eta = new TH1F("h_genA0_eta","CMS Simulation (Pythia) 13 TeV; #eta of A0; Fraction of events",100,-2.5,2.5);
  TH1F * h_genA0_phi = new TH1F("h_genA0_phi","CMS Simulation (Pythia) 13 TeV; #phi of A0; Fraction of events",100,-3.2,3.2);
  
  TH1F * h_genA1_m = new TH1F("h_genA1_m","CMS Simulation (Pythia) 13 TeV; Mass of A1 [GeV]; Fraction of events",100,0,100);
  TH1F * h_genA1_pT = new TH1F("h_genA1_pT","CMS Simulation (Pythia) 13 TeV; p_{T} of A1 [GeV]; Fraction of events",100,0,100);
  TH1F * h_genA1_px = new TH1F("h_genA1_px","CMS Simulation (Pythia) 13 TeV; p_{x} of A1 [GeV]; Fraction of events",100,-100,100);
  TH1F * h_genA1_py = new TH1F("h_genA1_py","CMS Simulation (Pythia) 13 TeV; p_{y} of A1 [GeV]; Fraction of events",100,-100,100);
  TH1F * h_genA1_pz = new TH1F("h_genA1_pz","CMS Simulation (Pythia) 13 TeV; p_{z} of A1 [GeV]; Fraction of events",100,-100,100);
  TH1F * h_genA1_eta = new TH1F("h_genA1_eta","CMS Simulation (Pythia) 13 TeV; #eta of A1; Fraction of events",100,-2.5,2.5);
  TH1F * h_genA1_phi = new TH1F("h_genA1_phi","CMS Simulation (Pythia) 13 TeV; #phi of A1; Fraction of events",100,-3.2,3.2);

  TH1F * h_genA0Mu0_pT = new TH1F("h_genA0Mu0_pT","CMS Simulation (Pythia) 13 TeV; p_{T} of #mu [GeV]; Fraction of events",100,0,100);
  TH1F * h_genA0Mu1_pT = new TH1F("h_genA0Mu1_pT","CMS Simulation (Pythia) 13 TeV; p_{T} of #mu [GeV]; Fraction of events",100,0,100);
  TH1F * h_genA1Mu0_pT = new TH1F("h_genA1Mu0_pT","CMS Simulation (Pythia) 13 TeV; p_{T} of #mu [GeV]; Fraction of events",100,0,100);
  TH1F * h_genA1Mu1_pT = new TH1F("h_genA1Mu1_pT","CMS Simulation (Pythia) 13 TeV; p_{T} of #mu [GeV]; Fraction of events",100,0,100);
  ...
  TH1F * h_genA0Mu0_eta = new TH1F("h_genA0Mu0_eta","CMS Simulation (Pythia) 13 TeV; #eta of #mu; Fraction of events",100,-2.5,2.5);
  TH1F * h_genA0Mu1_eta = new TH1F("h_genA0Mu1_eta","CMS Simulation (Pythia) 13 TeV; #eta of #mu; Fraction of events",100,-2.5,2.5);
  TH1F * h_genA1Mu0_eta = new TH1F("h_genA1Mu0_eta","CMS Simulation (Pythia) 13 TeV; #eta of #mu; Fraction of events",100,-2.5,2.5);
  TH1F * h_genA1Mu1_eta = new TH1F("h_genA1Mu1_eta","CMS Simulation (Pythia) 13 TeV; #eta of #mu; Fraction of events",100,-2.5,2.5);
  ...
  makePlot(h_genH_m, "genH_m");
  makePlot(h_genH_px, "genH_px");
  makePlot(h_genH_py, "genH_py");
  makePlot(h_genH_pz, "genH_pz");
  makePlot(h_genH_eta, "genH_eta");
  makePlot(h_genH_phi, "genH_phi");
  ...
  makePlot4(h_genA0Mu0_pT, h_genA0Mu1_pT, h_genA1Mu0_pT, h_genA1Mu1_pT, "genAMu_pT");
  makePlot4(h_genA0Mu0_px, h_genA0Mu1_px, h_genA1Mu0_px, h_genA1Mu1_px, "genAMu_px");
  makePlot4(h_genA0Mu0_py, h_genA0Mu1_py, h_genA1Mu0_py, h_genA1Mu1_py, "genAMu_py");
  makePlot4(h_genA0Mu0_pz, h_genA0Mu1_pz, h_genA1Mu0_pz, h_genA1Mu1_pz, "genAMu_pz");
  makePlot4(h_genA0Mu0_eta, h_genA0Mu1_eta, h_genA1Mu0_eta, h_genA1Mu1_eta, "genAMu_eta");
  makePlot4(h_genA0Mu0_phi, h_genA0Mu1_phi, h_genA1Mu0_phi, h_genA1Mu1_phi, "genAMu_phi");
}
