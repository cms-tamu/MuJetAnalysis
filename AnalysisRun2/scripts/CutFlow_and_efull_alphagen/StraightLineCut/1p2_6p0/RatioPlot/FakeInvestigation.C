									...
									if(is2DiMuonsDzOK_FittedVtx){
										...
										if(is2DiMuonsMassOK_FittedVtx){
											...
											if(is2DiMuonsIsoTkOK_FittedVtx){
												...
												brokenCounter++;
												if(isDiMuonHLTFired){
													if( (fabs(diMuonC_FittedVtx_eta) <=1.2) || (fabs(diMuonC_FittedVtx_eta) > 1.2 && fabs(diMuonC_FittedVtx_Lxy) < 6) ){
													if( (fabs(diMuonF_FittedVtx_eta) <=1.2) || (fabs(diMuonF_FittedVtx_eta) > 1.2 && fabs(diMuonF_FittedVtx_Lxy) < 6) ){
													ev_isDiMuonHLTFired++;
													brokenCounter++;
													triggerFlag_std++;
													}
