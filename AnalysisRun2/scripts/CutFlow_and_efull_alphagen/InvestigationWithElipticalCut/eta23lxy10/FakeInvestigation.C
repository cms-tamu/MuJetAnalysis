									...
									if(is2DiMuonsDzOK_FittedVtx){
										...
										if(is2DiMuonsMassOK_FittedVtx){
											...
											if(is2DiMuonsIsoTkOK_FittedVtx){
												...
												brokenCounter++;
												if(isDiMuonHLTFired){
												if( (pow(diMuonC_FittedVtx_eta,2)/pow(2.3,2)) + (pow(diMuonC_FittedVtx_Lxy,2)/pow(10,2)) <= 1){
												      if( (pow(diMuonF_FittedVtx_eta,2)/pow(2.3,2)) + (pow(diMuonF_FittedVtx_Lxy,2)/pow(10,2)) <= 1){
													ev_isDiMuonHLTFired++;
													brokenCounter++;
													triggerFlag_std++;
													}
