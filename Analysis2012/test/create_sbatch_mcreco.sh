...
cd /fdata/scratch/castaned/Analysis2015data/SL6/MuJetAnalysis_TAMU/CMSSW_7_4_1_patch1/src/
export VO_CMS_SW_DIR=/cvmfs/cms.cern.ch
source $VO_CMS_SW_DIR/cmsset_default.sh
export SCRAM_ARCH=slc6_amd64_gcc491
eval \`scramv1 runtime -sh\`
cd /fdata/scratch/castaned/Analysis2015data/SL6/MuJetAnalysis_TAMU/CMSSW_7_4_1_patch1/src/MuJetAnalysis/Analysis2012/test
