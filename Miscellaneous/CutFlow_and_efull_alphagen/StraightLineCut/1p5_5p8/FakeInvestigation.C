...
//============= Global Variables ===========================//
TFile *BAM = new TFile("erec_alphagen_FittedVTX_withEllipticCut.root","RECREATE");
									...
									if(is2DiMuonsDzOK_FittedVtx){
										...
										if(is2DiMuonsMassOK_FittedVtx){
											...
											if(is2DiMuonsIsoTkOK_FittedVtx){
												...
												brokenCounter++;
												if(isDiMuonHLTFired){
													if( (fabs(diMuonC_FittedVtx_eta) <=1.5) || (fabs(diMuonC_FittedVtx_eta) > 1.5 && fabs(diMuonC_FittedVtx_Lxy) < 5.8) ){
													if( (fabs(diMuonF_FittedVtx_eta) <=1.5) || (fabs(diMuonF_FittedVtx_eta) > 1.5 && fabs(diMuonF_FittedVtx_Lxy) < 5.8) ){
													ev_isDiMuonHLTFired++;
													brokenCounter++;
													triggerFlag_std++;
													}
